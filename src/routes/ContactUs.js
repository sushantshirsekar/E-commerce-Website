...
const ContactUs = () => {
    ...
    const submitHandler = async (event) => {
        ...
        const res = await fetch('https://e-commerce-db-34fdc-default-rtdb.firebaseio.com/users.json', {
            method:'POST',
  ...
  return (
    <div className="bg-dark" style={{ height: "600px" }}>
      <div className="mt-5">
        ...
        >
          <Form className="mt-3 mb-5 d-block text-center justify-content-center" onSubmit={submitHandler}>
            ...
            <Form.Group className="mb-3 mt-3" controlId="formBasicSurName">
              ...
              <Form.Control ref={surnameRef} type="text" placeholder="Enter surname " />
            </Form.Group>
            <Form.Group
